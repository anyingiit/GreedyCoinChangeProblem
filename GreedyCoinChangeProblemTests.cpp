...
void expectFailureWhenKeyMissing() {
    ...
    Stock stock = {
            {10000, 1}, {5000, 1}, {1000, 1}, {500, 1},
            {100, 2},   {50, 2},   {10, 5},   {5, 3}, {2, 10} // Wrong key instead of 1.
    };
...
void expectFailureWhenStockTooSmall() {
    ...
    assertTrue(result.error() == "not has enothod stock to handle T", "Unexpected error message for insufficient stock");
}
